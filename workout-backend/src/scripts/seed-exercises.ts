...
const exercises = [
  ...
  },
  {
    ...
    equipment: 'None',
    difficulty: 'Beginner',
    instructions: 'Keep body straight, lower until chest nearly touches ground, push back up',
    isPreDefined: true,
  },
  {
    name: 'Dumbbell Flyes',
    ...
    difficulty: 'Intermediate',
    instructions: 'Lie on bench, arms extended with slight bend, lower weights out to sides, squeeze back up',
    isPreDefined: true,
  },
  ...
  // STRENGTH - LEGS
  {
    ...
    equipment: 'Barbell',
    difficulty: 'Intermediate',
    instructions: 'Bar on shoulders, lower by bending knees and hips, keep chest up',
    isPreDefined: true,
  },
  {
    name: 'Lunges',
  ...
  // STRENGTH - SHOULDERS
  {
    ...
    equipment: 'Barbell',
    difficulty: 'Intermediate',
    instructions: 'Bar at shoulders, press straight overhead, lower with control',
    isPreDefined: true,
  },
  {
    name: 'Lateral Raises',
    ...
    equipment: 'Dumbbells',
    difficulty: 'Beginner',
    instructions: 'Arms at sides, raise dumbbells out to sides until parallel to ground',
    isPreDefined: true,
  },
  ...
  // STRENGTH - ARMS
  {
    ...
    equipment: 'Dumbbells',
    difficulty: 'Beginner',
    instructions: 'Arms extended, curl weights toward shoulders, lower with control',
    isPreDefined: true,
  },
  {
    name: 'Tricep Dips',
    ...
    equipment: 'Dip Bar',
    difficulty: 'Intermediate',
    instructions: 'Support body on bars, lower by bending elbows, press back up',
    isPreDefined: true,
  },
...
async function seedExercises() {
  ...
  try {
    ...
    console.log(`   - Strength exercises: ${exercises.filter(e => e.type === 'strength').length}`);
    console.log(`   - Cardio exercises: ${exercises.filter(e => e.type === 'cardio').length}`);
    console.log(`   - Flexibility exercises: ${exercises.filter(e => e.type === 'flexibility').length}`);
    console.log(`   - Sports exercises: ${exercises.filter(e => e.type === 'sports').length}`);
